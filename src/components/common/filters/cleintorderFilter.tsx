...
type Props = {
  setOpenSide: Function;
};

export default ({ setOpenSide }: Props) => {
  const InputFields = [
    {
      type: 'text',
      name: 'search',
  ...
  return (
    <div id="aside-searc" className="col-aside aside-search">
      <div className="wrapper_aside-search">
        <div className="ico-filter" onClick={() => setOpenSide()}>
        ...
        <div>
          ...
          <div className="mb-3">
            <Lable className="d-block block-label" lable="Order number" />
            <Input type="text" placeholder="Order number" name="" />{' '}
          </div>
        ...
        <div className="item-filter mt-3"></div>
        <div className="mt-3">
          <Input type="text" placeholder="order date" name="" className="mb-2"/>
          <Input
            type="text"
