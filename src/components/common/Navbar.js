      ...
      <header className={`header ${props.className}`}>
        <Navbar collapseOnSelect expand="lg" bg="" variant="dark">
          <Navbar.Brand href="/">
            ...
            <img src={SmallLogo} className="phone-img" />
          </Navbar.Brand>
                      ...
                      {openSub ? (
                        <>
                          ...
                          <li onClick={() => setPurchase(!purchase)}>
                            {/* <a href=""> */}
                            <svg
                              class="svg-inline--fa fa-receipt fa-w-12 icon"
                              aria-hidden="true"
                              focusable="false"
                              data-prefix="fas"
                              data-icon="receipt"
                            ...
                            {purchase && (
                              <ul className="pl-0">
                                <li>
                                  <a href="/order">
                                    <svg
                                      class="svg-inline--fa fa-file-import fa-w-16 icon"
                                      aria-hidden="true"
                                      focusable="false"
                                      data-prefix="fas"
                          ...
                          <li onClick={() => setinvoice(!invoice)}>
                            <svg
                              class="svg-inline--fa fa-file-invoice fa-w-12 icon"
                              aria-hidden="true"
                              focusable="false"
                              data-prefix="fas"
                          ...
                          <li onClick={() => setcredit(!credit)}>
                            <svg
                              class="svg-inline--fa fa-file-invoice-dollar fa-w-12 icon"
                              aria-hidden="true"
                              focusable="false"
                              data-prefix="fas"
                          ...
                          <li>
                            <a href="">
                              <svg
                                class="svg-inline--fa fa-file-upload fa-w-12 icon"
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fas"
