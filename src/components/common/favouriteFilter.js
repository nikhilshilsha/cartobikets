    ...
    <div id="aside-searc" class="col-aside aside-search">
      <div className="wrapper_aside-search">
        ...
        <div className="tab-nav check">
          ...
          <label for="vehicle1">New</label>
          <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" />
          <label for="vehicle1">Old</label>
        </div>
        <div>
          <div className="mb-3">
            {" "}
        ...
        <div className="tab-nav check">
          <div>
            ...
            <label for="vehicle1">good condition</label>
          </div>
          <div>
            {" "}
            <input type="radio" id="vehicle1" name="vehicle1" value="Bike" />
            <label for="vehicle1">Damaged vehicle</label>
          </div>
        </div>
        <div className="mt-3">
        ...
        <div className="mt-3 check">
          {" "}
          <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" />
          <label for="vehicle1">Distribution chain</label>
        </div>
        <div className="quick_filter nav-default">
          <h4>
            <span>
