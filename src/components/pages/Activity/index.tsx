          ...
          <Row>
            <Col sm={3}>
              <div className="d-flex align-items-center activity">
                ...
                <div className="">
                  <h5 className="text-muted font-weight-normal m-0 text-truncate">
                    Vente
                  </h5>
                  <h2 className=" font-weight-bolder my-1">
                    <span>250 600</span>
                  </h2>
                  <p className="mb-0 text-muted">
                    <span className="text-danger"></span>
                    <span className="text-sm text-muted font-weight-normal m-0 text-truncate text-nowrap">
                      viesse de coissance
                    </span>
                  </p>
                </div>
